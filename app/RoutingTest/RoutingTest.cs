...
namespace RoutingTest
{
    internal static class RoutingTest
    {
        private static int Main(string[] args)
        {
            ...
            apiRoute = "https://f4d5iqwknf.execute-api.eu-west-2.amazonaws.com/api/depots ?";
            //apiRoute = "https://f4d5iqwknf.execute-api.eu-west-2.amazonaws.com/api/postcodes?postcode=\"CH43 8TJ\"";
            //apiRoute = "https://f4d5iqwknf.execute-api.eu-west-2.amazonaws.com/api/routes?routeAction = 'depot'";
            apiRoute = "https://f4d5iqwknf.execute-api.eu-west-2.amazonaws.com/api/depots?depotId=1";
